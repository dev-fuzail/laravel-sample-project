...
<div class="content">
    ...
    <div class="bg-secondary rounded h-100 p-4">
        ...
        <form method="POST" id="category_form" action="{{ route('category.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-4">
                    <div class="mb-3">
                        <label for="category_name" class="form-label">Category Name</label>
                        <input type="text" class="form-control" id="category_name" name="category_name" required aria-describedby="emailHelp">
                    </div>
                </div>
                {{-- <div class="col-4">
                    <div class="form-check form-switch">
                        <label class="form-check-label" for="status">Status</label><br>
                        <input class="form-check-input" style="margin: 10px 15px" type="checkbox" id="status" checked>
                      </div>
                </div> --}}
            </div>
            <div class="row">
